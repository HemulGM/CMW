...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, System.Win.Registry, COCUtils, StructUnit, Vcl.ComCtrls, Vcl.ImgList;
...
implementation
 uses Winapi.ShellAPI, Utils, WinServices;
 ...
 for i := 0 to ValueNames.Count - 1 do
  with FListView.Items.Add do
   begin
    ...
    if Caption = '' then Caption:=' (ѕо умолчанию)';
