...
uses
  ...
  Dialogs, ExtCtrls, ComCtrls, XPMan, ToolWin, ImgList, StdCtrls,
  Buttons, ShellCtrls, Vcl.FileCtrl, generics.collections, Vcl.RibbonActnMenus,
  Vcl.ButtonGroup, Vcl.ActnMan, Vcl.ActnList,
  Vcl.Imaging.pngimage, System.Actions, Vcl.ScreenTips, Vcl.ActnCtrls,
  Vcl.Themes, Vcl.Menus, Vcl.RibbonLunaStyleActnCtrls, Vcl.Ribbon,
  Vcl.ActnMenus, Vcl.RibbonObsidianStyleActnCtrls, Vcl.RibbonSilverStyleActnCtrls,
  Vcl.RibbonActnCtrls, Types,
  COCUtils, FWEventLog, WinProcesses, Autoruns, WinEvents, Ports, ContextMenu,
  StructUnit, OSInfo, Applications, Cleaner, Tasks, HDD, WinServices, Executting,
  CommonProp, Subs, Vcl.Grids, Vcl.ValEdit, WinFirewall, SmartHND, Vcl.AppEvnts,
...
type
  TFormMain = class(TForm)
    ...
    Label24: TLabel;
    RibbonPanel: TRibbon;
    RibbonPageStart: TRibbonPage;
    ActionManagerMain: TActionManager;
    RibbonGroupDefault: TRibbonGroup;
    RibbonApplicationMenuBar: TRibbonApplicationMenuBar;
    ActionUpdate: TAction;
    RibbonPageItems: TRibbonPage;
    RibbonGroupAR: TRibbonGroup;
    RibbonGroupTools: TRibbonGroup;
    ...
    RibbonPageFS: TRibbonPage;
    RibbonGroupClear: TRibbonGroup;
    ListViewParam: TListView;
    ActionLogView: TAction;
    QuickAccessToolbar: TRibbonQuickAccessToolbar;
    ...
    Label32: TLabel;
    ActionHDD: TAction;
    RibbonGroupSMART: TRibbonGroup;
    SpinEditDrv: TRibbonSpinEdit;
    RibbonGroupMonitoring: TRibbonGroup;
    ImageListGuage: TImageList;
    RibbonGroupRAM: TRibbonGroup;
    ImageMem: TImage;
    ...
    RibbonGroupCDrive: TRibbonGroup;
    ImageDrvC: TImage;
    ...
    ActionSwitchFW: TAction;
    ActionFWInfo: TAction;
    RibbonGroup2: TRibbonGroup;
    ActionShellExplorer: TAction;
    ...
    MemoDebug: TMemo;
    ActionDebug: TAction;
    ActionCmdLine: TAction;
    Memo1: TMemo;
    ActionLoadLog: TAction;
    ListViewItems: TListView;
    ListBoxState: TListBox;
    MenuItemFindSrvFile: TMenuItem;
    ActionFindSrvFile: TAction;
    ActionOpenSrvDll: TAction;
    MenuItemOpenSrvDll: TMenuItem;
    ActionARInfo: TAction;
    MenuItemARInfo: TMenuItem;
    MenuItemN6: TMenuItem;
    ActionDeleteAR: TAction;
    MenuItemDeleteAR: TMenuItem;
    FileOpenDialog: TFileOpenDialog;
    ActionEventsFN: TAction;
    ActionWillGetSysEvents: TAction;
    ActionWillGetBackupEvents: TAction;
    ActionSrvSTBoot: TAction;
    ActionSrvSTAutoDelayed: TAction;
    ActionSrvSTAuto: TAction;
    ActionSrvSTSys: TAction;
    ActionSrvSTDemand: TAction;
    ActionSrvSTDisable: TAction;
    ...
    ActionContextMenuGet: TAction;
    ComboBoxCMElem: TComboBox;
    ActionClasses: TAction;
    ActionClassGetNext: TAction;
    ActionClassGetSTop: TAction;
    ActionOpenHostsFile: TAction;
    ActionAbout: TAction;
    ActionCmdRun: TAction;
    TabSheetCMD: TTabSheet;
    MemoCMD: TMemo;
    RibbonGroupConsole: TRibbonGroup;
    PanelMenu: TPanel;
    ...
    Shape5: TShape;
    PanelBarBoxes: TPanel;
    ListViewGallery: TListView;
    Panel31: TPanel;
    PanelBarTasks: TPanel;
    SpeedButtonMenuMain: TsSpeedButton;
    SpeedButtonMenuLastBox: TsSpeedButton;
    SpeedButtonMenuGoArch: TsSpeedButton;
    SpeedButtonMenuGoWork: TsSpeedButton;
    SpeedButtonMenuGoSSDir: TsSpeedButton;
    SpeedButtonMenuGoDB: TsSpeedButton;
    Shape1: TShape;
    Shape2: TShape;
    Panel32: TPanel;
    TabSheetMenuBox: TTabSheet;
    Shape9: TShape;
    ...
    Panel29: TPanel;
    SpeedButtonMenuQuickPrint: TsSpeedButton;
    SpeedButtonMenuPrintSet: TsSpeedButton;
    Panel48: TPanel;
    Panel50: TPanel;
    Label50: TLabel;
    EditPrintPages: TEdit;
    Panel51: TPanel;
    Label49: TLabel;
    SpinEditPrintCopies: TlkSpinEdit;
    Panel49: TPanel;
    CheckBoxMenuAddtoArch: TCheckBox;
    CheckBoxMenuSaveCust: TCheckBox;
    PanelBarExport: TPanel;
    Panel37: TPanel;
    Panel46: TPanel;
    SpeedButtonMenuPrintPreview: TsSpeedButton;
    Panel47: TPanel;
    SpeedButtonMenuPrintExport: TsSpeedButton;
    SpeedButtonMenuOpenExports: TsSpeedButton;
    TabSheetMenuDB: TTabSheet;
    Shape16: TShape;
    PanelBarDBControl: TPanel;
    SpeedButtonMenuDB: TsSpeedButton;
    SpeedButtonMenuCust: TsSpeedButton;
    SpeedButtonMenuDBArch: TsSpeedButton;
    Shape17: TShape;
    Shape18: TShape;
    Shape19: TShape;
    Panel53: TPanel;
    Panel55: TPanel;
    SpeedButtonMenuUpdateDB: TsSpeedButton;
    SpeedButtonMenuDBWork: TsSpeedButton;
    SpeedButtonMenuDBSSDir: TsSpeedButton;
    TabSheetMenuSettings: TTabSheet;
    Shape23: TShape;
    Shape27: TShape;
    Shape57: TShape;
    Shape58: TShape;
    ...
    Panel56: TPanel;
    Panel57: TPanel;
    CheckBoxDebug3D: TCheckBox;
    CheckBox3DContour: TCheckBox;
    ...
    Panel39: TPanel;
    Panel41: TPanel;
    SpeedButtonSetSSDir: TsSpeedButton;
    ...
    procedure RibbonPanelTabChange(Sender: TObject; const NewIndex,
  ...
  public
    ...
    function FillComboBoxES:Boolean;
    function FillComboBoxET:Boolean;
    function FillComboBoxED:Boolean;
  end;
...
uses ShellAPI, Registry, IniFiles, Utils, Vcl.Clipbrd, Regeditor, LoadingForm, System.UITypes, About;
...
procedure TFormMain.RibbonPanelTabChange(Sender: TObject; const NewIndex,
  OldIndex: Integer; var AllowChange: Boolean);
begin
 if NewIndex = 2 then OpenResult;
end;
...
begin
 case ComboBoxEventsList.ItemIndex of
  ...
  begin
   if FillComboBoxES then ComboBoxEventsList.ItemIndex:=2;
   ES:=esSystem;
  end;
 end;
 ...
 case ComboBoxEventType.ItemIndex of
  ...
  begin
   if FillComboBoxET then ComboBoxEventType.ItemIndex:=1;
   ET:=rtError;
  end;
 end;
 ...
 case ComboBoxEventsDate.ItemIndex of
  ...
  if TryStrToInt(ComboBoxEventsDate.Text, IntD) then DD:=IntD
   ...
   begin
    if FillComboBoxED then ComboBoxEventsDate.ItemIndex:=2;
    DD:=14;
   end;
 end;
...
function TFormMain.FillComboBoxES:Boolean;
begin
 if not Assigned(ComboBoxEventsList) then Exit(False);
 try
...
function TFormMain.FillComboBoxET:Boolean;
begin
 if not Assigned(ComboBoxEventType) then Exit(False);
 try
...
function TFormMain.FillComboBoxED:Boolean;
begin
 if not Assigned(ComboBoxEventsDate) then Exit(False);
 try
...
begin
 ...
 //TimerCurElem.Enabled:=True;
 //FormLoading.Destroy;
 if FormLoading <> nil then FormLoading.Destroy;
end;
...
begin
 ...
 try
   ...
   RibbonGroupRAM.Caption:=Format('ОЗУ %d%%', [lpMemoryStatus.dwMemoryLoad]);
 ...
 try
   ...
   RibbonGroupCDrive.Caption:=Format(C[1]+':\ %d%%', [ID]);
 ...
 try
   CPU:=Round(CPUUsage);
   NewPointForCPU(CPU);
   RibbonGroupCPUUsage.Caption:=Format('ЦП %d%%', [CPU]);
