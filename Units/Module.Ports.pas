...
uses
  ...
  Dialogs, StdCtrls, Winsock, Winsock2, ComCtrls, CMW.Utils,
  CMW.ModuleStruct, CMW.OSInfo, Vcl.Grids, Vcl.ValEdit, Vcl.ExtCtrls;
...
implementation
 uses Vcl.ImgList, CMW.Main, IniFiles, Module.WinProcesses;
