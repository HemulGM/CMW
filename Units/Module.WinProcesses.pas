...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, ExtCtrls, ComCtrls, TLHelp32, PSAPI, CMW.Utils,
  CMW.ModuleStruct, Winapi.ShellAPI, Vcl.StdCtrls, Vcl.Grids, Vcl.ValEdit;
